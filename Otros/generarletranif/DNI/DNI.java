...
public class DNI {
    ...
    public static void comporbarDNI(String dni) throws DNIException {
        ...
        try {
            ...
            System.out.println("Letra " + letra + " posArray " + pos + " Número " + numero);
    ...
    //metodo para obtener solo la letra con los 8 primeros numeros
